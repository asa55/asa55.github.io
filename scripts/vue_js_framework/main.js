...
var app = new Vue({ 
    ...
    data: {
        ...
        */
        ...
        postgresql: {
            alt: "postgresql logo",
            description: "My experience with PostgreSQL comes largely from Django, which integrates well with PostgreSQL as the backend database due to its official support.",
            followlink: ``,
